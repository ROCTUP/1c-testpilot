...
- 10 инструментов по типам объектов клиента тестирования; конкретная операция выбирается
  параметром `action` (до 154 действий). Версионный гейтинг по целевой версии платформы.
...
([пример](profiles.example.yaml)), указав его путь в `TC1C_PROFILES_FILE`.
...
параметром `action`, до 154 действий. Список действий с методами 1С, применимыми типами и
