...
- 10 инструментов по типам объектов клиента тестирования; конкретная операция выбирается
  параметром `action` (до 138 действий). Версионный гейтинг по целевой версии платформы.
...
параметром `action`, до 138 действий. Список действий с методами 1С, применимыми типами и
