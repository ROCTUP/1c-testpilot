...
- 10 инструментов по типам объектов клиента тестирования; конкретная операция выбирается
  параметром `action` (137 действий). Версионный гейтинг по целевой версии платформы.
...
параметром `action`, всего 137 действий. Список действий с методами 1С, применимыми типами и
